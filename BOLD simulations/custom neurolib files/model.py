...
class Model:
    ...
    def initializeBold(self):
        ...
        self.boldModel = bold.BOLDModel(
            N=self.params["N"],
            dt=self.params["dt"],
            normalize_input=self.params.get('bold_normalize_input', False),
            normalize_max=self.params.get('bold_normalize_max', 50),
            # Add these new parameters:
            rho=self.params.get('bold_rho', 0.34),
            alpha=self.params.get('bold_alpha', 0.32),
            V0=self.params.get('bold_V0', 0.02),
            k1=self.params.get('bold_k1', 3.72),
            k2=self.params.get('bold_k2', 0.53),
            k3=self.params.get('bold_k3', 0.53),
            Gamma=self.params.get('bold_Gamma', 0.41),
            K=self.params.get('bold_K', 0.65),
            Tau=self.params.get('bold_Tau', 0.98)
        )
